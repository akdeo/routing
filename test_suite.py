...
def main():
    ...
    t.test('dv_router', 'tests.test_simple_v2')
    t.test('dv_router', 'tests.extra_test1')
    ...
    t.test('dv_router', 'tests.test_equal_costs_path')
    t.test('dv_router', 'tests.test_multiple_routers')
    t.test('dv_router', 'tests.test_simple_split_horizon')
    t.test('dv_router', 'tests.test_dont_forget_direct_paths_after_failure')
    ...
    t.test(
      'dv_router',
     'tests.count_to_infinity_v2',
      extra_args=['--poison-mode'])
    t.test(
      'dv_router',
     'tests.test_recover_from_count_to_infinity',
      extra_args=['--poison-mode'])
    t.test(
       'dv_router',
